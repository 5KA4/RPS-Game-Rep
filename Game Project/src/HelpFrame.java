...
public class HelpFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setFont(new java.awt.Font("UD Digi Kyokasho N-B", 0, 14)); // NOI18N
        jTextArea1.setLineWrap(true);
        jTextArea1.setRows(5);
        jTextArea1.setText("Welcome to Rock Paper Scissors Ultimate! \nA game in which you get to play rock paper scissors.\nbut with a twist!  \nEvery 2 points in a row,  \nyou get a chance to obtain a 2x point  \nThis will help boost you to  victory!  \nGood luck!");
